    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:block lg:w-1/2 bg-primary-900 relative overflow-hidden">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1483985988355-763728e1935b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80')] bg-cover bg-center opacity-40 mix-blend-overlay"></div>
                <div className="absolute inset-0 bg-gradient-to-br from-primary-900/90 to-primary-800/90"></div>
                <div className="relative h-full flex flex-col justify-center px-12 text-white">
                    <h2 className="text-5xl font-bold mb-6 font-display">Welcome Back</h2>
                    <p className="text-xl text-primary-100 max-w-md leading-relaxed">
                        Sign in to access your curated collection of premium urban essentials.
                    </p>
                </div>
            </div>
                ...
                <div className="max-w-md w-full">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full btn-primary py-3.5 text-base shadow-lg shadow-primary-900/20"
                        >
                            {loading ? (
